...
public class BeschleunigungActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.beschleunigung_layout);

        tvInfo = (TextView) findViewById(R.id.textviewAccelerometer);
            ...
            listener = new SensorEventListener() {
                ...
                public void onSensorChanged(SensorEvent event) {
                    if (event.values.length > 0) {
                        ...
                        tvInfo.setText(getString(R.string.type_accelerometer, text1, text2, text3));
                    }
                }
